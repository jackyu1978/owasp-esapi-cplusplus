  ...
  */
  const HTMLEntityCodec::EntityMap& HTMLEntityCodec::getCharacterToEntityMap()
  {
    ...
    if(!init)
    {
      ...
      tm[TextConvert::WideToNarrow(WideString(1,161))] = "iexc"; /* inverted exclamation mark */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,168))] = "um"; /* diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,184))] = "cedi"; /* cedilla */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,199))] = "Ccedi"; /* Latin capital letter c with cedilla */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,203))] = "Eum"; /* Latin capital letter e with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,207))] = "Ium"; /* Latin capital letter i with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,214))] = "Oum"; /* Latin capital letter o with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,220))] = "Uum"; /* Latin capital letter u with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,228))] = "aum"; /* Latin small letter a with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,231))] = "ccedi"; /* Latin small letter c with cedilla */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,235))] = "eum"; /* Latin small letter e with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,239))] = "ium"; /* Latin small letter i with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,246))] = "oum"; /* Latin small letter o with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,252))] = "uum"; /* Latin small letter u with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,255))] = "yum"; /* Latin small letter y with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,376))] = "Yum"; /* Latin capital letter y with diaeresis */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,8226))] = "bul"; /* bullet */
      tm[TextConvert::WideToNarrow(WideString(1,8230))] = "hellip"; /* horizontal ellipsis */
      tm[TextConvert::WideToNarrow(WideString(1,8240))] = "permi"; /* per mille sign */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,8260))] = "fras"; /* fraction slash */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,8476))] = "rea"; /* black-letter capital r */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,8704))] = "foral"; /* for all */
      ...
      tm[TextConvert::WideToNarrow(WideString(1,8968))] = "lcei"; /* left ceiling */
      tm[TextConvert::WideToNarrow(WideString(1,8969))] = "rcei"; /* right ceiling */
