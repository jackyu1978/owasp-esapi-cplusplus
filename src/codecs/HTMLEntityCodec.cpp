...
namespace esapi
{
  unsigned int HTMLEntityCodec::REPLACEMENT_CHAR()
  {
    return 65533;
  }
  ...
  String HTMLEntityCodec::encodeCharacter( const Char* immune, size_t length, int c) const
  {
    ASSERT(immune);
    ASSERT(length);
