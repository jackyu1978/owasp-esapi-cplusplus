...
#ifndef _EnterpriseSecurityException_H_
#define _EnterpriseSecurityException_H_
 ...
 */
class EnterpriseSecurityException : public std::runtime_error
{
protected:
...
public:
	 ...
	 * 			  the message logged
     */
	EnterpriseSecurityException::EnterpriseSecurityException(std::string, std::string);
    ...
    EnterpriseSecurityException::~EnterpriseSecurityException() throw() {};
};

};

#endif /* _EnterpriseSecurityException_H_ */
