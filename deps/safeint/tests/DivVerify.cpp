...
static const DivTest< unsigned __int64, unsigned __int64 > uint64_uint64[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< unsigned __int64, unsigned __int32 > uint64_uint32[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< unsigned __int64, unsigned __int16 > uint64_uint16[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyUint64Uint16()
{
	...
	for( i = 0; i < sizeof(uint64_uint16)/sizeof(uint64_uint16[0]); ++i )
	{
		...
		if( SafeDivide(uint64_uint16[i].x, uint64_uint16[i].y, ret) != uint64_uint16[i].fExpected )
		{
			...
			cerr << hex << setw(16) << setfill('0') << uint64_uint16[i].y << ", ";
		...
		if( fSuccess != uint64_uint16[i].fExpected )
		{
			...
			// uint64_uint16[i].x, uint64_uint16[i].y, uint64_uint16[i].fExpected ? "true" : "false");
			cerr << "Error in case uint64_uint16 throw: ";
			cerr << hex << setw(16) << setfill('0') << uint64_uint16[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << uint64_uint16[i].y << ", ";
			cerr << "expected = " << uint64_uint16[i].fExpected << endl;
		}
...
static const DivTest< unsigned __int64, unsigned __int8 > uint64_uint8[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyUint64Uint8()
{
	...
	for( i = 0; i < sizeof(uint64_uint8)/sizeof(uint64_uint8[0]); ++i )
	{
		...
		if( SafeDivide(uint64_uint8[i].x, uint64_uint8[i].y, ret) != uint64_uint8[i].fExpected )
		{
			...
			cerr << hex << setw(16) << setfill('0') << uint64_uint8[i].y << ", ";
		...
		if( fSuccess != uint64_uint8[i].fExpected )
		{
			...
			// uint64_uint8[i].x, uint64_uint8[i].y, uint64_uint8[i].fExpected ? "true" : "false");
			cerr << "Error in case uint64_uint8 throw: ";
			cerr << hex << setw(16) << setfill('0') << uint64_uint8[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << uint64_uint8[i].y << ", ";
			cerr << "expected = " << uint64_uint8[i].fExpected << endl;
		}
...
// individually
static const DivTest< unsigned __int64, __int64 > uint64_int64[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< __int64, unsigned __int64 > int64_uint64_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, true },
	{ 2,                     0, true },
...
void DivVerifyUint64Int64_2()
{
	...
	for( i = 0; i < sizeof(int64_uint64_2)/sizeof(int64_uint64_2[0]); ++i )
	{
		...
		if( fSuccess != int64_uint64_2[i].fExpected )
		{
			...
			cerr << "Error in case int64_uint64_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_uint64_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_uint64_2[i].y << ", ";
			cerr << "expected = " << int64_uint64_2[i].fExpected << endl;
		}
	}
}

static const DivTest< unsigned __int64, __int32 > uint64_int32[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< __int32, unsigned __int64 > int32_uint64_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, true },
	{ 2,                     0, true },
...
void DivVerifyUint64Int32_2()
{
	...
	for( i = 0; i < sizeof(int32_uint64_2)/sizeof(int32_uint64_2[0]); ++i )
	{
		...
		if( fSuccess != int32_uint64_2[i].fExpected )
		{
			...
			cerr << "Error in case int32_uint64_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int32_uint64_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int32_uint64_2[i].y << ", ";
			cerr << "expected = " << int32_uint64_2[i].fExpected << endl;
		}
	}
}

static const DivTest< unsigned __int64, __int16 > uint64_int16[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyUint64Int16()
{
	...
	for( i = 0; i < sizeof(uint64_int16)/sizeof(uint64_int16[0]); ++i )
	{
		...
		{
			//assert(false);
			// printf("Error in case uint64_int16: %I64X, %I64X, expected = %s\n",
			...
			cerr << hex << setw(16) << setfill('0') << uint64_int16[i].y << ", ";
		...
		if( fSuccess != uint64_int16[i].fExpected )
		{
			...
			// uint64_int16[i].x, uint64_int16[i].y, uint64_int16[i].fExpected ? "true" : "false");
			cerr << "Error in case uint64_int16 throw: ";
			cerr << hex << setw(16) << setfill('0') << uint64_int16[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << uint64_int16[i].y << ", ";
			cerr << "expected = " << uint64_int16[i].fExpected << endl;
		}
...
static const DivTest< __int16, unsigned __int64 > int16_uint64_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, true },
	{ 2,                     0, true },
...
void DivVerifyUint64Int16_2()
{
	...
	for( i = 0; i < sizeof(int16_uint64_2)/sizeof(int16_uint64_2[0]); ++i )
	{
		...
		if( fSuccess != int16_uint64_2[i].fExpected )
		{
			...
			cerr << "Error in case int16_uint64_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int16_uint64_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int16_uint64_2[i].y << ", ";
			cerr << "expected = " << int16_uint64_2[i].fExpected << endl;
		}
	}
}

static const DivTest< unsigned __int64, __int8 > uint64_int8[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyUint64Int8()
{
	...
	for( i = 0; i < sizeof(uint64_int8)/sizeof(uint64_int8[0]); ++i )
	{
		...
		{
			//assert(false);
			// printf("Error in case uint64_int8: %I64X, %I64X, expected = %s\n",
			...
			cerr << hex << setw(16) << setfill('0') << uint64_int8[i].y << ", ";
		...
		if( fSuccess != uint64_int8[i].fExpected )
		{
			// printf("Error in case uint64_int32 throw: %I64X, %X, expected = %s\n",
			// uint64_int8[i].x, uint64_int8[i].y, uint64_int8[i].fExpected ? "true" : "false");
			cerr << "Error in case uint64_int8 throw: ";
			cerr << hex << setw(16) << setfill('0') << uint64_int8[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << uint64_int8[i].y << ", ";
			cerr << "expected = " << uint64_int8[i].fExpected << endl;
		}
...
static const DivTest< __int8, unsigned __int64 > int8_uint64_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, true },
	{ 2,                     0, true },
...
void DivVerifyUint64Int8_2()
{
	...
	for( i = 0; i < sizeof(int8_uint64_2)/sizeof(int8_uint64_2[0]); ++i )
	{
		...
		if( fSuccess != int8_uint64_2[i].fExpected )
		{
			...
			cerr << "Error in case int8_uint64_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int8_uint64_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int8_uint64_2[i].y << ", ";
			cerr << "expected = " << int8_uint64_2[i].fExpected << endl;
		}
	}
}

static const DivTest< __int64, __int64 > int64_int64[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< __int64, __int32 > int64_int32[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyInt64Int32()
{
	...
	for( i = 0; i < sizeof(int64_int32)/sizeof(int64_int32[0]); ++i )
	{
		...
		if( SafeDivide(int64_int32[i].x, int64_int32[i].y, ret) != int64_int32[i].fExpected )
		{
			...
			cerr << hex << setw(16) << setfill('0') << int64_int32[i].y << ", ";
		...
		if( fSuccess != int64_int32[i].fExpected )
		{
			...
			// int64_int32[i].x, int64_int32[i].y, int64_int32[i].fExpected ? "true" : "false");
			cerr << "Error in case int64_int32 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_int32[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_int32[i].y << ", ";
			cerr << "expected = " << int64_int32[i].fExpected << endl;
		}
...
static const DivTest< __int64, __int32 > int64_int32_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyInt64Int32_2()
{
	...
	for( i = 0; i < sizeof(int64_int32_2)/sizeof(int64_int32_2[0]); ++i )
	{
		...
		if( fSuccess != int64_int32_2[i].fExpected )
		{
			...
			cerr << "Error in case int64_int32_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_int32_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_int32_2[i].y << ", ";
			cerr << "expected = " << int64_int32_2[i].fExpected << endl;
		}
	}
}

static const DivTest< __int64, unsigned __int64 > int64_uint64[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
static const DivTest< __int64, unsigned __int64 > int64_uint64_3[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyInt64Uint64_2()
{
	...
	for( i = 0; i < sizeof(int64_uint64_3)/sizeof(int64_uint64_3[0]); ++i )
	{
		...
		if( fSuccess != int64_uint64_3[i].fExpected )
		{
			...
			cerr << "Error in case int64_uint64_3 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_uint64_3[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_uint64_3[i].y << ", ";
			cerr << "expected = " << int64_uint64_3[i].fExpected << endl;
		}
	}
}

static const DivTest< __int64, unsigned __int32 > int64_uint32[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyInt64Uint32()
{
	...
	for( i = 0; i < sizeof(int64_uint32)/sizeof(int64_uint32[0]); ++i )
	{
		...
		if( SafeDivide(int64_uint32[i].x, int64_uint32[i].y, ret) != int64_uint32[i].fExpected )
		{
			...
			cerr << hex << setw(16) << setfill('0') << int64_uint32[i].y << ", ";
		...
		if( fSuccess != int64_uint32[i].fExpected )
		{
			...
			// int64_uint32[i].x, int64_uint32[i].y, int64_uint32[i].fExpected ? "true" : "false");
			cerr << "Error in case int64_uint32 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_uint32[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_uint32[i].y << ", ";
			cerr << "expected = " << int64_uint32[i].fExpected << endl;
		}
...
static const DivTest< __int64, unsigned __int32 > int64_uint32_2[] = 
{
	{ 0,                     0, false },
	{ 1,                     0, false },
	{ 2,                     0, false },
...
void DivVerifyInt64Uint32_2()
{
	...
	for( i = 0; i < sizeof(int64_uint32_2)/sizeof(int64_uint32_2[0]); ++i )
	{
		...
		if( fSuccess != int64_uint32_2[i].fExpected )
		{
			...
			cerr << "Error in case int64_uint32_2 throw: ";
			cerr << hex << setw(16) << setfill('0') << int64_uint32_2[i].x << ", ";
			cerr << hex << setw(16) << setfill('0') << int64_uint32_2[i].y << ", ";
			cerr << "expected = " << int64_uint32_2[i].fExpected << endl;
		}
	}
}
